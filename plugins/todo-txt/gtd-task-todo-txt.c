...
static void
gtd_task_todo_txt_finalize (GObject *object)
{
  GtdTaskTodoTxt *self = (GtdTaskTodoTxt *)object;

  G_OBJECT_CLASS (gtd_task_todo_txt_parent_class)->finalize (object);
}
...
gtd_task_todo_txt_class_init (GtdTaskTodoTxtClass *klass)
{
  ...
  object_class->finalize = gtd_task_todo_txt_finalize;
